...
mkdir -p "$BUILD/data" "$BUILD/sanramon/data" "$BUILD/contracosta/data"
...
for f in index.html app/index.html sanramon/app/index.html \
         contracosta/app/index.html data/la.geojson \
         sanramon/data/sanramon.geojson contracosta/data/contracosta.geojson; do
...
san-ramon ($(git -C "$REPO" rev-parse --short san-ramon)) and contra-costa
($(git -C "$REPO" rev-parse --short contra-costa)). Do not edit this branch
